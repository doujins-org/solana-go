...
[![Go Report Card](https://goreportcard.com/badge/github.com/doujins-org/solana-go)](https://goreportcard.com/report/github.com/doujins-org/solana-go)
...
**If you're looking for a SERUM library, you can check out [gagliardetto/serum-go](https://github.com/gagliardetto/serum-go) ([./programs/serum](https://github.com/doujins-org/solana-go/tree/main/programs/serum) is deprecated.**)
...
You can wait for a transaction confirmation using the `github.com/doujins-org/solana-go/rpc/sendAndConfirmTransaction` package tools (for a complete example: [see here](#transfer-sol-from-one-wallet-to-another-wallet))
...
import (
	...
	lookup "github.com/doujins-org/solana-go/programs/address-lookup-table"
...
import (
  ...
  "github.com/doujins-org/solana-go/rpc"
  "github.com/doujins-org/solana-go/text"
)
...
import (
  ...
  "github.com/doujins-org/solana-go/programs/system"
  "github.com/doujins-org/solana-go/rpc"
  confirm "github.com/doujins-org/solana-go/rpc/sendAndConfirmTransaction"
  "github.com/doujins-org/solana-go/rpc/jsonrpc"
  "github.com/doujins-org/solana-go/rpc/ws"
  "github.com/doujins-org/solana-go/text"
)
